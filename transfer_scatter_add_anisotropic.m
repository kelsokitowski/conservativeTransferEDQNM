...
% 1. S_NL_ISO: kernel1
% ============================================================================
% Sk_raw = 0.5*(kernel1(E0q, E0p, E0k, ...) + kernel1(E0p, E0q, E0k, ...))
term1_k = kernel1(E0q, E0p, E0k, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_k = kernel1(E0p, E0q, E0k, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel1(E0k, E0q, E0p, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_p = kernel1(E0q, E0k, E0p, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel1(E0k, E0p, E0q, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_q = kernel1(E0p, E0k, E0q, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
...
% 2. S_NL_DIR: kernel2
% ============================================================================
% Sk_raw = 0.5*(kernel2(...) + kernel2(...))
term1_k = kernel2(E0q, E0p, E0k, HPOLq, HPOLp, HDIRq, HDIRp, HDIRk, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_k = kernel2(E0p, E0q, E0k, HPOLp, HPOLq, HDIRp, HDIRq, HDIRk, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel2(E0k, E0q, E0p, HPOLk, HPOLq, HDIRk, HDIRq, HDIRp, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_p = kernel2(E0q, E0k, E0p, HPOLq, HPOLk, HDIRq, HDIRk, HDIRp, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel2(E0k, E0p, E0q, HPOLk, HPOLp, HDIRk, HDIRp, HDIRq, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_q = kernel2(E0p, E0k, E0q, HPOLp, HPOLk, HDIRp, HDIRk, HDIRq, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sq_raw = 0.5 * (term1_q + term2_q);
...
term2_k = kernel3(E0p, E0q, E0k, HPOLp, HPOLq, HPOLk, HDIRp, HDIRq, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel3(E0k, E0q, E0p, HPOLk, HPOLq, HPOLp, HDIRk, HDIRq, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_p = kernel3(E0q, E0k, E0p, HPOLq, HPOLk, HPOLp, HDIRq, HDIRk, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel3(E0k, E0p, E0q, HPOLk, HPOLp, HPOLq, HDIRk, HDIRp, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
term2_q = kernel3(E0p, E0k, E0q, HPOLp, HPOLk, HPOLq, HDIRp, HDIRk, k, p, q, mu1_k, mu1_p, mu1_q, kj, pj, qj, nu, t);
Sq_raw = 0.5 * (term1_q + term2_q);
...
term2_k = kernel4(Eq, E0Tp, E0Tk, k, p, q, mu3_q, nu, D, t-t0);
STk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel4(Ek, E0Tp, E0Tq, k, p, q, mu3_k, nu, D, t-t0);
term2_p = kernel4(Ek, E0Tq, E0Tp, k, p, q, mu3_k, nu, D, t-t0);
STp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel4(Ep, E0Tq, E0Tk, k, p, q, mu3_p, nu, D, t-t0);
term2_q = kernel4(Ep, E0Tk, E0Tq, k, p, q, mu3_p, nu, D, t-t0);
...
term2_k = kernel5(E0p, E0q, E0Tk, E0Tq, E0Tp, HPOLp, HPOLq, HDIRp, HDIRq, HTk, HTq, HTp, k, p, q, mu3_q, nu, D, t-t0);
STk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel5(E0k, E0q, E0Tp, E0Tq, E0Tk, HPOLk, HPOLq, HDIRk, HDIRq, HTp, HTq, HTk, k, p, q, mu3_k, nu, D, t-t0);
term2_p = kernel5(E0q, E0k, E0Tp, E0Tk, E0Tq, HPOLq, HPOLk, HDIRq, HDIRk, HTp, HTk, HTq, k, p, q, mu3_k, nu, D, t-t0);
STp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel5(E0k, E0p, E0Tq, E0Tk, E0Tp, HPOLk, HPOLp, HDIRk, HDIRp, HTq, HTk, HTp, k, p, q, mu3_p, nu, D, t-t0);
term2_q = kernel5(E0p, E0k, E0Tq, E0Tp, E0Tk, HPOLp, HPOLk, HDIRp, HDIRk, HTq, HTp, HTk, k, p, q, mu3_p, nu, D, t-t0);
STq_raw = 0.5 * (term1_q + term2_q);
...
term2_k = kernel6(E0p, E0k, E0q, EFk, EFp, EFq, k, p, q, mu3_p, mu3_q, mu3_k, nu, D, t-t0);  % Same for now
SFk_raw = 0.5 * (term1_k + term2_k);

term1_p = kernel6(E0q, E0p, E0k, EFp, EFq, EFk, k, p, q, mu3_q, mu3_k, mu3_p, nu, D, t-t0);
term2_p = kernel6(E0q, E0p, E0k, EFp, EFq, EFk, k, p, q, mu3_q, mu3_k, mu3_p, nu, D, t-t0);
SFp_raw = 0.5 * (term1_p + term2_p);

term1_q = kernel6(E0k, E0q, E0p, EFq, EFk, EFp, k, p, q, mu3_k, mu3_p, mu3_q, nu, D, t-t0);
term2_q = kernel6(E0k, E0q, E0p, EFq, EFk, EFp, k, p, q, mu3_k, mu3_p, mu3_q, nu, D, t-t0);
